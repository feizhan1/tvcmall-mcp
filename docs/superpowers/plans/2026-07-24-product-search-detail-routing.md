...
- [x] **Step 1: 为 WebApi `data.Products[].Url` 编写失败测试**
...
- [x] **Step 2: 运行 HTTP client 测试确认失败**
...
- [x] **Step 2: 映射权威 WebApi 商品列表与 URL**
...
- [x] **Step 3: 限制详情工具只能接收 WebApi 详情路径**
